  ...
  render() {
    return (
      <ScrollView>
        ...
        {/* //curly braces for javascript embedded in JSX. if showCalendar is false, DateTimePicker not shown at all */}
        {this.state.showCalendar && (
          <DateTimePicker
            value={this.state.date}
            mode={"date"}
            display="default"
            // saves selected date to state and hides calendar
            onChange={(event, selectedDate) => {
              // logical and operator makes sure state is set only if selectedDate is truthy
